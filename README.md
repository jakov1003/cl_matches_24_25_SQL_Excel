...
I wanted to show every piece of data, but the table was too large and difficult to read. To improve readability, I divided the table into three sections using the dropdown menu technique. 
